...
<TwoColumns>
  <Figure slot="left" caption="Unitree H1 jogging.">
    <YouTubeVideo videoId="N6JUwqmXvvY" />
  </Figure>
  <Figure slot="right" caption="Unitree G1 jogging.">
    <YouTubeVideo videoId="h-LTSjqxV4k" />
  </Figure>
</TwoColumns>
